...
import ProffesionalSummaryForm from "../components/home/ProffesionalSummaryForm";
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-gradient-to-r from-green-500 to-green-700 border-none transition-all duration-2000"
                style={{
                  width: `${
                ...
                <div className="flex items-center">
                  ...
                  {activeSectionIndex !== 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition-all"
                    >
              ...
              ring-orange-300 text-orange-700 ring hover:ring-orange-500
            ...
            <div className="relative w-full">
              ...
              >
                {resumeData.public && (
                  ...
                  bg-gradient-to-br from-purple-200 to-purple-200  text-purple-800 hover:ring transition-colors rounded-lg"
                  >
