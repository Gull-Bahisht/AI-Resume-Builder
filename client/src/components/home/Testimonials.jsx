...
const Testimonials = () => {
  ...
  return (
    ...
    <BookUserIcon className='size-4.5 stroke-orange-400'/>
    <span>Testimonials</span>
    </div>

    <Title title="Don't just take our words" description="Your opinion matters to us! Tell us what you loved or how we can make your experience even better."/>
